...
{title:'Eat Only Food Vegetarian For 2 Days Per Week', description: 'You will be able to smugly join conversations with other Vegetarians and Vegans now', category: 'Food', difficulty: 'Medium', footprint: -2154},
{title:'Dispose of All Aluminium Items Through Recycling', description: 'You should already be recycling all required items or else your apartment building is probably getting fined.', category: 'Food', difficulty: 'Easy', footprint: -89},
...
{title:'Go 1 Month Without Buying Any New Clothes', description: 'For the fashion forward, this will be difficult but since you are hang drying your clothes now then your current ones will last longer', category: 'Goods', difficulty: 'Medium', footprint: -167},
...
{title:'Cut Your Daily Shower Time By 5 Minutes', description: 'According to the BBC, the average shower lasts around 8 mins & uses 2.5 gallons per minute. Skip the daydreaming and get clean!', category: 'Home', difficulty: 'Easy', footprint: -104},
{title:'Skip A Shower For 1 Day Every Week', description: 'Pick a day when you do little to no social or physical activity. You dont need to shower if youre going to be inside watching football all day on Sundays.', category: 'Home', difficulty: 'Medium', footprint: -167},
{title:'Drive 50% Fewer Miles Compared To Last Year', description: 'Start car-pooling, taking public transportation more frequently, or choosing an eco-friendly mode of transportation like riding a bike.', category: 'Travel', difficulty: 'Medium', footprint: -5793},
{title:'Replace Your Shower Head With A Low Flow Model', description: 'Using a low-flow shower head can save 350 pounds of CO2e per year. Setting the temperature to 120°F can help improve a hot water heater’s efficiency.', category: 'Home', difficulty: 'Easy', footprint: -350},
{title:'Dispose of All Paper Items Through Recycling', description: 'You should already be recycling all required items or else your apartment building is probably getting fined.', category: 'Food', difficulty: 'Easy', footprint: -113},
...
{title:'Dispose of All Glass Items Through Recycling', description: 'You should already be recycling all required items or else your apartment building is probably getting fined.', category: 'Food', difficulty: 'Easy', footprint: -25},
...
{title:'Work From Your Home for 1 Day Per Week', description: 'Remind your boss of your companies rarely followed WFH policy and enjoy answering emails in your pajamas.', category: 'Travel', difficulty: 'Medium', footprint: -527},
...
{title:'Replace Eating Beef with Chicken for 1 Month', description: 'Cows are one of the largest contributors to greenhouse gasses like carbon dioxide and methane. Do your part by cutting consumption on occassion.', category: 'Food', difficulty: 'Medium', footprint: -78},
{title:'Expand The Mini-Garden You Started', description: 'Ambitious gardeners that use their garden to replace 20% of bought food can reduce their carbon footprint as well as eat healthier!', category: 'Food', difficulty: 'Medium', footprint: -68},
...
{title:'Eat Only Food Vegetarian For 1 Day Per Week', description: 'You will be able to smugly join conversations with other Vegetarians and Vegans now', category: 'Food', difficulty: 'Easy', footprint: -1077},
{title:'Replace Eating Beef with Chicken for 1 Year', description: 'Cows are one of the largest contributors to greenhouse gasses like carbon dioxide and methane. Do your part by cutting consumption for entire year.', category: 'Food', difficulty: 'Hard', footprint: -882},
...
{title:'Enable the Power Save Setting on Your Computer', description: 'This will help maintain your computers battery for the long term as well as reduce your footprint', category: 'Goods', difficulty: 'Easy', footprint: -67},
{title:'Turn Your Computer Off When its Not in Use', description: 'If every PC in the world were shut off for one night, the energy saved could light the Empire State Building for over 30 years.', category: 'Goods', difficulty: 'Easy', footprint: -571},
...
{title:'Dispose of All Plastic Items Through Recycling', description: 'You should already be doing this but just in case you dont, google plastic effecting turtles', category: 'Food', difficulty: 'Easy', footprint: -36},
...
{title:'Go 1 Year Without Buying Any New Clothes', description: 'This is very hard because things happen and people need to buy new things but if you can accomplish it then kudos!', category: 'Goods', difficulty: 'Hard', footprint: -2000}
])
